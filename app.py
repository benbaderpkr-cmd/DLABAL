...
# --- FONCTION ADDITIONNELLE POUR LE CALCUL ---
...
# AIGUILLAGE VERS LA NOUVELLE PAGE
if st.session_state.get("page_actuelle") == "calcul_ferti":
    page_calcul_ferti()

# --- CAS 2 : AFFICHAGE FICHE (TON CODE INITIAL) ---
elif sel:
    ...
    with tab3:
        # Ton code GSheets / THO original sans aucune modification
        conn = st.connection("gsheets", type=GSheetsConnection)
        URL_SHEET = "https://docs.google.com/spreadsheets/d/16n6kX-p-fD-BIn7IasFm6vE7f-J6LgY_F_R_X_X_X_X/edit"
        df_gs = conn.read(spreadsheet=URL_SHEET, worksheet="THO")
        # ... (le reste de ta logique THO continue ici dans ton fichier)

# --- CAS 3 : PAGE D'ACCUEIL (TEXTE ORIGINAL PRESERVE) ---
else:
